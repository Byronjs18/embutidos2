// Lista completa de departamentos y municipios de Guatemala
const departamentos = {
  "Alta Verapaz": [
    "Cobán", "Santa Cruz Verapaz", "San Cristóbal Verapaz", "Tactic",
    "Tamahú", "Tucurú", "Panzós", "Senahú", "San Pedro Carchá",
    "San Juan Chamelco", "Santa María Cahabón", "Chisec",
    "Fray Bartolomé de las Casas", "Santa Catalina La Tinta", "Raxruhá"
  ],
  "Baja Verapaz": [
  ...
  "Escuintla": [
    ...
    "San José", "Iztapa", "Palín", "San Vicente Pacaya", "Nueva Concepción"
  ],
  "Guatemala": [
    ...
    "Fraijanes", "Amatitlán", "Villa Nueva", "Villa Canales", "San Miguel Petapa"
  ],
  "Huehuetenango": [
    ...
    "San Sebastián Huehuetenango", "Tectitán", "Concepción Huista",
    "San Juan Ixcoy", "San Antonio Huista", "San Sebastián Coatán",
    "Barillas", "Aguacatán", "San Rafael Petzal", "San Gaspar Ixchil",
  ...
  "Jutiapa": [
    ...
    "Yupiltepeque", "Atescatempa", "Jerez", "El Adelanto",
    "Zapotitlán", "Comapa", "Jalpatagua", "Conguaco", "Moyuta", "Pasaco", "Quesada"
  ],
  "Petén": [
  ...
  "Santa Rosa": [
    ...
    "Oratorio", "San Juan Tecuaco", "Chiquimulilla", "Taxisco",
...
function cargarDepartamentos() {
  ...
  // cambiar municipios cuando se selecciona un departamento
  deptSelect.addEventListener("change", () => {
    muniSelect.innerHTML = "<option value=''>Seleccione un municipio</option>";
    if (departamentos[deptSelect.value]) {
      departamentos[deptSelect.value].forEach(muni => {
        const option = document.createElement("option");
        option.value = muni;
...
// Exponer la función globalmente para que funcione desde el modal
